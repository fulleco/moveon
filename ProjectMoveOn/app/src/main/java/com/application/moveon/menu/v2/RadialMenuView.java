...
import com.application.moveon.menu.v2.*;
import com.application.moveon.menu.v2.RadialMenuHelperFunctions;
import com.application.moveon.menu.v2.RadialMenuRenderer;
...
public class RadialMenuView extends View {
	...
	private boolean handleEvent(int e) {
		...
		mRadialMenuContent.get(e).getOnRadailMenuClick()
			.onRadialMenuClickedListener(mRadialMenuContent.get(e).getMenuID());
		selected = -1;
		invalidate();
		return true;
	}
