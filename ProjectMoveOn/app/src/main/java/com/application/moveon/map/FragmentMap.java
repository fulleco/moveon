    ...
    private void sendMessage(String idCircle, String idSender, String idReceiver, String content, String date, String id_image){
        ...
        if(idSender.equals(idReceiver)){
            mainmos.addMessages(idCircle, idSender,
                    receivers.trim(), content, new SimpleDateFormat("dd-MM-yyyy'T'HH:mm").format(new Date()),
                    0,id_image, new AddMessages_Callback(activity, progressDialog));
        }else {
            mainmos.addMessage(idCircle, idSender,
                    idReceiver, content, new SimpleDateFormat("dd-MM-yyyy'T'HH:mm").format(new Date()),
                    0,id_image, new AddMessage_Callback(activity, progressDialog));
        }
    }
        ...
        childItemIncoming
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage("1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "J'arrive !", "J'arrive !","rocket");
                    }
                });
        ...
        childItemLate
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Je suis en retard !", "date","watch");
                    }
                });
        ...
        childItemLost
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Je suis perdu...", "date","crying");
                    }
                });
        ...
        childItemArrived
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Je suis perdu...", "date","fire");
                    }
                });
        ...
        childItemLeaving
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Je pars !", "date","door");
                    }
                });
        ...
        childItemJoinMe
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Rejoins-moi", "date","running");
                    }
                });
        ...
        childItemSos
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "J'ai besoin d'aide !", "date","help");
                    }
                });
        ...
        childItemCigaret
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        // here.
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin, "Pause clope ?", "date","cigarette");
                    }
                });
                ...
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","eating");
                    }
                });
        ...
        childrenCute
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","cute");
                    }
                });
        ...
        childrenBigSmile
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","big_smile");
                    }
                });
        ...
        childrenHaha
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","haha");
                    }
                });
        ...
        childrenUpset
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","upset");
                    }
                });
        ...
        childrenCrying
                .setOnMenuItemPressed(new RadialMenuItem.RadialMenuItemClickListener() {
                    ...
                    public void execute() {
                        ...
                        dismissMenu(pieMenu);
                        sendMessage( "1", session.getUserDetails().get(SessionManager.KEY_ID), selectedLogin,
                                session.getUserDetails().get(SessionManager.KEY_FIRSTNAME) + " vous envoie un smiley", "date","crying");
                    }
                });
