...
package com.application.moveon.menu.v1;
...
import com.application.moveon.menu.v1.*;
import com.application.moveon.menu.v1.RadialMenuHelper;
import com.application.moveon.menu.v1.RadialMenuItem;
import com.application.moveon.menu.v1.RadialMenuWedge;
...
public class RadialMenuWidget extends View {
    ...
    private BitmapShader defaultShader;
														// pieces
    ...
    private BitmapShader outlineShader;
		...
		if (state == MotionEvent.ACTION_DOWN) {
			...
			if (Wedge2Shown == true) {
				for (int i = 0; i < Wedges2.length; i++) {
					com.application.moveon.menu.v1.RadialMenuWedge f = Wedges2[i];
    ...
    public void setInnerRingShader(Bitmap bitmap, int alpha) {
        this.defaultAlpha = alpha;

        //Initialize the BitmapShader with the Bitmap object and set the texture tile mode
        this.defaultShader = new BitmapShader(bitmap, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
    }

    public void setOuterRingShader(Bitmap bitmap, int alpha) {
        this.defaultAlpha = alpha;

        //Initialize the BitmapShader with the Bitmap object and set the texture tile mode
        this.outlineShader = new BitmapShader(bitmap, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
    }
